...
import { ICertificateTemplateService } from '../interfaces/IServices/i-certificate-template.service';
import { CreateCertificate, UpdateCertificate } from "../inputs/certificate.input"
import { TransactionType } from "../interfaces/extended/transaction-type.extend"
import { CertificateInfo } from '../types/certificate-info.type';
...
export class CertificateService implements ICertificateService {
  ...
  private async generateCertificate(certificate: CertificateInfo, templateURL: string) {
    const generateCertificateURL = process.env.Generate_Certificate_URL as string;
